// Delmål för ST Radiologi (basspecialitet) enligt HSLF-FS 2021:8 samt
// målbeskrivningen för radiologi. För radiologi gäller delmålen a1–a6, b1, b3
// samt c1–c13.
//
...
export const RADIOLOGI: Specialty = {
  id: "radiologi",
  name: "Radiologi",
  group: "Bild- och funktionsmedicinska specialiteter",
  type: "bas",
  goalMonths: 60,
  departments: RADIOLOGI_DEPARTMENTS,
  categories: [
    {
      id: "a",
      ...
      milestones: [
        ...
        { id: "a3", shortTitle: "a3", title: "a3 – Vårdhygien och smittskydd" },
        {
          id: "a4",
          shortTitle: "a4",
          title: "a4 – Systematiskt kvalitets- och patientsäkerhetsarbete",
        },
        { id: "a5", shortTitle: "a5", title: "a5 – Medicinsk vetenskap" },
        {
          id: "a6",
          shortTitle: "a6",
          title: "a6 – Lagar och andra föreskrifter samt hälso- och sjukvårdens organisation",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      description:
        "Delmålen c1–c4 utgör den gemensamma kunskapsbasen för radiologi och klinisk fysiologi.",
      milestones: [
        {
          id: "c1",
          shortTitle: "c1",
          title: "c1 – Undersökningsresultat och undersökningsmetoder",
        },
        {
          id: "c2",
          shortTitle: "c2",
          title: "c2 – Anatomi, fysiologi och patofysiologi med relevans för radiologin",
        },
        ...
        { id: "c12", shortTitle: "c12", title: "c12 – Urogenital radiologi" },
        {
          id: "c13",
          shortTitle: "c13",
          title: "c13 – Tillämpa lagar och föreskrifter inom kompetensområdet",
        },
      ],
    },
  ],
